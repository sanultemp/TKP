...
(function ($) {
  ...
  var invsJs = {
    ...
    methods: function (e) {
      ...
      invsJs.swiperJs();
      invsJs.salActive();
      invsJs.videoActivation();
      invsJs.searchOption();
      invsJs.cartBarshow();
      invsJs.sideBarTwoshow();
      invsJs.metismenu();
      invsJs.sideMenu();
      invsJs.backToTopInit();
      invsJs.filterPrice();
      invsJs.preloader();
      invsJs.onePageNav();
      invsJs.serviceHover();
      invsJs.countDown();
      invsJs.magnificPopupActivation();
      invsJs.categoryMenuHover();
      invsJs.filterActionButton();
      invsJs.showMoreBtn();
      invsJs.menuCurrentLink();
      invsJs.addtoWishlist();
      invsJs.dateUpdate();
      invsJs.uploadImage();
      invsJs.customSelect();
      invsJs.contactForm();
    ...
    swiperJs: function () {
          ...
          var swiperMain = new Swiper(".thumbBannerSlide", {
            ...
            on: {
              init: function () {
                ...
                }, 100); // ছোট delay রাখলে নিশ্চিতভাবে কাজ করে
              },
            },
          });
      ...
      $(document).ready(function () {
        ...
        // Check if the sliders exist in the DOM
        if ($(".SlideThumb").length && $(".thumbBannerSlideTwo").length) {
          // Initialize Thumbnail Slider
          var swiperThumb = new Swiper(".SlideThumb", {
            slidesPerView: 3,
            spaceBetween: 0,
